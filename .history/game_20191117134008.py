...
def player_one_goes(tank2):
    ...
    if (int(tank2) == int(endpoint_for_tank1_shot)):
        ...
        print(f'You shot and hit {endpoint_for_tank1_shot}, you were {int(tank2)+int(endpoint_for_tank1_shot)-int(tank2)} off of tank2!')
        return True    
...
def player_two_goes(tank1):
    ...
    if (int(tank1) == int(endpoint_for_tank2_shot)):
        ...
        print(f'You shot and hit {endpoint_for_tank2_shot}, you were {int(tank1)+int(endpoint_for_tank2_shot)-int(tank1)} off of tank1!')
        return True    

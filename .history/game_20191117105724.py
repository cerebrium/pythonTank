...
def player_one_goes(tank2, endpoint_for_tank1_shot):
    if (int(tank2) == int(endpoint_for_tank1_shot)):
        print(f'you hit tank2!')
        return False
    else:
        print('you missed tank2!')
        endpoint_for_tank2_shot = get_velocity_and_angle()
        return True    

def player_two_goes(tank2, endpoint_for_tank1_shot):
    if (int(tank2) == int(endpoint_for_tank2_shot)):
        print(f'you hit tank2!')
        return False
    else:
        print('you missed tank2!')
...
def play_game():
    ...
    endpoint_for_tank2_shot = get_velocity_and_angle()
    while True:
        player_one_goes(tank2, endpoint_for_tank1_shot)
        player_two_goes(tank1, endpoint_for_tank2_shot)
